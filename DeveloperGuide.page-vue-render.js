...
with(this){return _c('p',[_v("The view feature allows users to view clients with the compulsory field  "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("index")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("User can view a client at the specified index.")]),_v(" "),_c('li',[_v("User can see a list-view of policies that this client is covered by.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Fri, 29 Mar 2024, 21:46:39 GMT+8]")])])])}
}];
